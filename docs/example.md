...
An example application is available for download together with the C# and C++ SDK [here](https://www.weart.it/repository/downloads/samples/weart-integration-csharp-sdk-v1.2.0.zip).
